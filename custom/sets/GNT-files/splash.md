...
**Gigantic** is a draftable premier set using Play Boosters, containing 271 cards (20 mythic rares, 60 rares, 100 uncommons, 81 commons, 5 basic-rarity dual lands, and 5 basic lands). Bundle purchasers will also obtain a promotional alternate art copy of Cephaleviathan, while all boosters have a chance of containing the Headliner toxic foil version of Powerbomb.
...
<img align="right" width="300" style="margin:15px" src="https://grapplex.github.io/sets/GNT-files/deck.png" "GNT theme deck"/>

**Gigantic** is accompanied by a preconstructed theme deck, aimed for casual kitchen-table play. [**<font color="#004628">Monster All-Out Attack!</font>**](https://grapplex.github.io/deck?id=neOQr8kpJw) is green-blue deck that leverages the power of fossil mana to outpace your opponent, racing ahead of them in your manabase and disrupting their plays until you can finish out the game with an expensive apex ability or drown your opponents in cards and value. Push forward with aggressive affinity creatures like Ascendant Demolisher, and use Titanic Smash to clear through any potential blockers. Harness the power of Shipwrecker Spawn to refill your hand, then copy it with Gokuaku, Primitive Isle to do it all over again next turn. Grow your Fecund Newtant with one apex ability and follow it up by pumping your whole board with the other ability. Get big, and all-out attack. 